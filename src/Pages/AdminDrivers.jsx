...
const AdminDrivers = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.delete(`http://13.229.216.243:8000/api/driver/${driverToDelete._id}`);
  ...
  const handleStatusChange = async (driverId, newStatus) => {
    try {
      await axios.put(`http://13.229.216.243:8000/api/driver/${driverId}`, { 
        status: newStatus 
      });
                ...
                onMouseLeave={(e) => {
                  ...
                  <div style={{
                    ...
                    {driver.driverImageUrl ? (
                      <img
                        src={`http://13.229.216.243:8000${driver.driverImageUrl}`}
              ...
              <div className="vehicle-info-preview">
                <div className="vehicle-preview-image">
                  {driverToDelete.driverImageUrl ? (
                    <img
                      src={`http://13.229.216.243:8000${driverToDelete.driverImageUrl}`}
